...
class REFER:
    def __init__(self, dataset, with_parses=False, splitBy='licheng'):
        '''
        ...
        self.IMAGE_DIR = osp.join(self.ROOT_DIR, 'data', 'images', 'mscoco', 'images', 'train2014') if dataset in ['refcoco', 'refcoco+'] \
            else osp.join(self.ROOT_DIR, 'data', 'images', 'saiapr_tc-12')
        self.PROPOSAL_DIR = osp.join(self.ROOT_DIR, 'data', 'images', 'mscoco', 'proposals', 'train2014') if dataset in ['refcoco', 'refcoco+'] \
            else None
