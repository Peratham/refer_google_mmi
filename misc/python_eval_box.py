...
[{'sent', 'tokens', 'ref_id', 'image_id', 'bbox', 'split', 'pred_bbox', 'pred_loss'}]

We will compare 'bbox' and 'pred_bbox' if there IoU >= 0.5, and we will write html later on.
"""
...
for sent in predictions:
	...
	inter, union = computeIoU(gd_bbox, pred_bbox)
